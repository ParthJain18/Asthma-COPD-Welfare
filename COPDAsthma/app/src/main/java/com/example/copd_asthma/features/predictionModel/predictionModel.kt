...
fun predictCOPDSeverity(
    ...
    val model = Interpreter(loadModelFile("COPD_SEVERITY_CHECKER.tflite", context))
    ...
    // Create input tensor
    val inputBuffer = TensorBufferFloat.createFixedSize(intArrayOf(1, 15), DataType.FLOAT32)
